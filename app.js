...
const STRINGS = {
  el: {
    ...
    'mq.5': '3D Printing and CAD',
    'mq.6': 'Web Design',
    'mq.7': 'Laser Cut and Sheet Metal',
    'mq.8': 'Εγκρίσεις Τύπου',
    'about.eyebrow': 'Σχετικά με εμένα',
    'about.h':   'Μηχανικός με <em>πάθος</em> για το αποτέλεσμα',
    'about.p1':  'Είμαι Μηχανολόγος Μηχανικός με 5 πανεπιστημιακούς τίτλους από 3 χώρες — BEng ΑΠΘ, MSc École Centrale Paris, MSc IFP School (Παρίσι), MSc ΔΠΘ και MBA Washington University of Science and Technology. Με 10+ χρόνια στον τομέα, συνδυάζω βαθιά τεχνική γνώση με πρακτική εμπειρία σε ένα ευρύ φάσμα έργων.',
    'about.p2':  'Διευθύνω την <strong>Expertease Designs</strong> στην Αθήνα, παρέχοντας ολοκληρωμένες μηχανολογικές υπηρεσίες — από άδειες ρυμουλκούμενων Ο1/Ο2 και ενεργειακά πιστοποιητικά, έως τεχνικό ασφαλείας, 3D printing and web design.',
    ...
    'ec.5': '3D Printing and Rapid Prototyping',
    'ec.6': 'Web Design and Software',
    ...
    'tr.s1': 'Αρχική εκτίμηση και κατηγοριοποίηση',
    'tr.s2': 'Σύνταξη τεχνικής μελέτης',
    'tr.s3': 'Υποβολή στις αρμόδιες αρχές',
    'tr.s4': 'Παρακολούθηση και έκδοση άδειας',
    ...
    's1.t': 'Μελέτες Οχημάτων και Άδειες Ο1/Ο2',
    's1.d': 'Μελέτες ειδικών και ρυμουλκούμενων οχημάτων, εγκρίσεις τύπου. Πλήρης αδειοδότηση Ο1/Ο2.',
    's2.t': 'Ενεργειακά Πιστοποιητικά (ΠΕΑ)',
    's2.d': 'Έκδοση ΠΕΑ για κατοικίες και επαγγελματικούς χώρους — υποχρεωτικό για αγοροπωλησία και μίσθωση.',
    's3.t': 'Τεχνικός Ασφαλείας',
    's3.d': 'Κάλυψη Τεχνικού Ασφαλείας (Ν.3850/2010), σύνταξη ΓΕΕΚ, εκπαιδεύσεις και προετοιμασία για ΣΕΠΕ.',
    's4.t': 'Μηχανολογικός Σχεδιασμός και 3D Printing',
    's4.d': 'CAD 3D (SolidWorks), FEA αντοχών, rapid prototyping — FDM, SLA, SLS για ακριβή εξαρτήματα.',
    's5.t': 'Web Design και Ανάπτυξη Λογισμικού',
    's5.d': '100% custom websites χωρίς templates. Ειδικό λογισμικό για τεχνικές εφαρμογές.',
    's6.t': 'Laser Cut και Κατεργασία Μετάλλου',
    ...
    'cred.eyebrow': 'Σπουδές και Τίτλοι',
    ...
    'd3.t': 'Ενέργεια και Πετρελαϊκή Μηχανική',
    'd4.t': 'Τεχνολογία και Επιχειρηματικότητα',
    ...
    't1.d': 'Τεχνικό Γραφείο Γκούβελης και Συνεργάτες — Θεσσαλονίκη. Εξειδίκευση σε μελέτες οχημάτων, εγκρίσεις τύπου και αδειοδότηση ρυμουλκούμενων.',
    't2.n': 'Σταύρος Μάλλιαρης', 't2.r': 'Τεχνικός Ασφαλείας — MEng, ASP®',
    't2.d': 'Πιστοποιημένος Μηχανικός Υγείας και Ασφάλειας ΑΠΘ. 7+ χρόνια διεθνούς εμπειρίας σε ΓΕΕΚ, εκπαιδεύσεις εργαζομένων και επιθεωρήσεις ΣΕΠΕ.',
    ...
    'ct.intro': 'Είτε χρειάζεστε άδεια ρυμουλκούμενου Ο1/Ο2, ενεργειακό πιστοποιητικό, κάλυψη τεχνικού ασφαλείας ή οποιαδήποτε άλλη τεχνική υπηρεσία — επικοινωνήστε μαζί μας.',
  ...
  en: {
    ...
    'tr.s1': 'Initial assessment and categorisation',
    'tr.s2': 'Technical study preparation',
    'tr.s3': 'Submission to competent authorities',
    'tr.s4': 'Follow-up and licence issuance',
    ...
    's1.t': 'Vehicle Studies and O1/O2 Licences',
    's1.d': 'Special and trailer vehicle studies, type approvals. Full O1/O2 licensing.',
    's2.t': 'Energy Performance Certificates (EPC)',
    's2.d': 'EPC issuing for residences and commercial spaces — mandatory for sale and lease.',
    's3.t': 'Safety Engineer',
    's3.d': 'Safety Engineer coverage (Law 3850/2010), risk assessment (GEEK), employee training and SEPE preparation.',
    's4.t': 'Mechanical Design and 3D Printing',
    's4.d': '3D CAD (SolidWorks), FEA analysis, rapid prototyping — FDM, SLA, SLS for precision parts.',
    's5.t': 'Web Design and Software Development',
    's5.d': '100% custom websites, no templates. Specialised software for technical applications.',
    's6.t': 'Laser Cutting and Sheet Metal',
    's6.d': 'Laser cutting and engraving, sheet metal work, precision parts manufacturing.',
    ...
    'cred.eyebrow': 'Education and Degrees',
    ...
    'd3.t': 'Energy and Petroleum Engineering',
    'd4.t': 'Technology and Entrepreneurship',
    'd5.t': 'Business Administration',
    ...
    't1.d': 'Gkouvelis Technical Office and Associates — Thessaloniki. Specialisation in vehicle studies, type approvals and trailer licensing.',
    't2.n': 'Stavros Malliaris', 't2.r': 'Safety Engineer — MEng, ASP®',
    't2.d': 'Certified Health and Safety Engineer, AUTH. 7+ years of international experience in risk assessments, employee training and SEPE inspections.',
    ...
    'ct.intro': 'Whether you need an O1/O2 trailer licence, energy certificate, safety engineer coverage or any other technical service — get in touch.',
