...
const STRINGS = {
  el: {
    ...
    'about.p1':  'Είμαι Μηχανολόγος Μηχανικός με 5 πανεπιστημιακούς τίτλους από 3 χώρες — BEng ΑΠΘ, MSc École Centrale Paris, MSc IFP School (Παρίσι), MSc ΔΠΘ και MBA Washington University of Science & Technology. Με 10+ χρόνια στον τομέα, συνδυάζω βαθιά τεχνική γνώση με πρακτική εμπειρία σε ένα ευρύ φάσμα έργων.',
