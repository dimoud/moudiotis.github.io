...
const STRINGS = {
  el: {
    ...
    's1.d': 'Μελέτες ειδικών & ρυμουλκούμενων οχημάτων, εγκρίσεις τύπου. Λογισμικό Mechanical ExpertEase για μελέτες ΚΕΚ/ΙΕΚΕΜ. Πλήρης αδειοδότηση Ο1/Ο2.',
    's2.t': 'Ενεργειακά Πιστοποιητικά (ΠΕΑ)',
    's2.d': 'Έκδοση Πιστοποιητικών Ενεργειακής Απόδοσης για κατοικίες και επαγγελματικούς χώρους. Ενεργειακός επιθεωρητής κτηρίων — υποχρεωτικό για αγοροπωλησία & μίσθωση.',
    's3.t': 'Τεχνικός Ασφαλείας',
    's3.d': 'Κάλυψη Τεχνικού Ασφαλείας (Ν.3850/2010), σύνταξη ΓΕΕΚ, εκπαιδεύσεις εργαζομένων, σχέδια εκκένωσης, προσομοίωση & προετοιμασία για επιθεώρηση ΣΕΠΕ.',
    's4.t': 'Μηχανολογικός Σχεδιασμός & 3D Printing',
    's4.d': 'CAD 3D (SolidWorks), FEA ανάλυση αντοχών, rapid prototyping. FDM, SLA, SLS τεχνολογίες εκτύπωσης για ακριβή εξαρτήματα και πρωτότυπα.',
    's5.t': 'Web Design & Ανάπτυξη Λογισμικού',
    's5.d': 'Κατασκευή επαγγελματικών websites χωρίς templates — 100% custom. Ανάπτυξη ειδικού λογισμικού για τεχνικές εφαρμογές.',
    's6.t': 'Laser Cut & Κατεργασία Μετάλλου',
    's6.d': 'Κοπή και εγχάραξη με laser, κατεργασία φύλλων μετάλλου, παραγωγή εξαρτημάτων ακριβείας για βιομηχανικές και ερευνητικές εφαρμογές.',
    'sb.title': 'Γνωρίζατε;',
  ...
  en: {
    ...
    's1.d': 'Special & trailer vehicle studies, type approvals. Mechanical ExpertEase software for KEK/IEKEM studies. Full O1/O2 licensing.',
    's2.t': 'Energy Performance Certificates (EPC)',
    's2.d': 'Issuing Energy Performance Certificates for residences and commercial spaces. Energy auditor — mandatory for sale & lease transactions.',
    's3.t': 'Safety Engineer',
    's3.d': 'Safety Engineer coverage (Law 3850/2010), written risk assessment (GEEK), employee training, evacuation plans, SEPE inspection simulation & preparation.',
    's4.t': 'Mechanical Design & 3D Printing',
    's4.d': '3D CAD (SolidWorks), FEA strength analysis, rapid prototyping. FDM, SLA, SLS printing technologies for precision parts and prototypes.',
    's5.t': 'Web Design & Software Development',
    's5.d': 'Professional websites without templates — 100% custom. Development of specialised software for technical applications.',
    's6.t': 'Laser Cutting & Sheet Metal',
    's6.d': 'Laser cutting and engraving, sheet metal work, precision parts manufacturing for industrial and research applications.',
