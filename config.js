...
window.SITE_CONFIG = {
    ...
    services: [
        ...
        },
        {
            ...
            textEl:      'Η κάλυψη <strong class="kw">Τεχνικού Ασφαλείας</strong> για <strong class="kw">κάθε επιχείρηση</strong>, ακόμα &amp; με 1 εργαζόμενο είναι υποχρεωτική. Σύνταξη <strong class="kw">ΓΕΕΚ</strong>, εκπαιδεύσεις εργαζομένων, σχέδια εκκένωσης, προετοιμασία ΣΕΠΕ.',
        ...
        },
        {
            ...
            textEl:      'Τεχνική μελέτη για εγκατάσταση <strong class="kw">υδραυλικών πλατφορμών</strong> σε οχήματα &amp; σταθερές εγκαταστάσεις.',
        ...
        {
            icon:        'fa-solar-panel',
            titleEl:     'Ενεργειακό Πιστοποιητικό ΠΕΑ',
            titleEn:     'Energy Performance Certificate EPC — Mechanical Engineer Athens',
            textEl:      'Έκδοση <strong class="kw">Πιστοποιητικών Ενεργειακής Απόδοσης (ΠΕΑ)</strong> για κατοικίες &amp; επαγγελματικούς χώρους.',
        ...
        },
        {
            ...
            titleEl:     '<strong>Μηχανολογικός Σχεδιασμός</strong> &amp; 3D Printing',
            titleEn:     '<strong>Mechanical Design</strong> &amp; 3D Printing',
        ...
        },
        {
            ...
            titleEl:     '<strong>Web Design</strong> — Κατασκευή Ιστοσελίδων',
            titleEn:     '<strong>Web Design</strong> — Website Development',
