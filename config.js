...
window.SITE_CONFIG = {
    ...
    services: [
        ...
        },
        {
            ...
            textEl:      'Εκπόνηση <strong class="kw">μελέτης ενεργητικής πυροπροστασίας</strong> για κτίρια και εμπορικούς χώρους.',
        ...
        },
        {
            ...
            textEl:      'Τεχνική μελέτη για εγκατάσταση <strong class="kw">υδραυλικών πλατφορμών</strong> σε οχήματα και σταθερές εγκαταστάσεις.',
        ...
        },
        {
            ...
            textEl:      'Έκδοση <strong class="kw">Πιστοποιητικών Ενεργειακής Απόδοσης (ΠΕΑ)</strong> για κατοικίες και επαγγελματικούς χώρους.',
            textEn:      'Issuing <strong class="kw">Energy Performance Certificates (EPC)</strong> by a <strong class="kw">mechanical engineer</strong> for residences and commercial spaces. Mandatory for sale and lease — <strong class="kw">fast issuance</strong> and competitive pricing, Athens and Thessaloniki.',
