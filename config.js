...
window.SITE_CONFIG = {
    ...
    meta: {
        ...
        descriptionEl: 'Τεχνικό Γραφείο Μουδιώτης — εγκρίσεις τύπου οχημάτων & ρυμουλκούμενων, μεμονωμένη έγκριση, καταχώρηση ΤΑΟ, άδεια τρέιλερ Ο1/Ο2, μελέτες & μετασκευές. Αθήνα.',
        descriptionEn: 'Moudiotis Technical Office — vehicle type approvals, individual vehicle approval, TAO registration, O1/O2 trailer licence, technical studies & conversions.',
        lang:          'el',
    },
    ...
    marquee: [
        ...
        { el: 'Ειδικές Κατασκευές & Μετασκευές',   en: 'Special Bodywork & Conversions' },
    ...
    services: [
        ...
        },
        {
            ...
            titleEl:     'Εγκρίσεις Τύπου &amp; Ταξινόμηση Οχημάτων',
            titleEn:     'Type Approvals &amp; Vehicle Registration',
            ...
            items: [
                {
                    titleEl: 'Εθνική &amp; Ευρωπαϊκή Έγκριση Τύπου',
                    titleEn: 'National &amp; European Type Approval',
        ...
        },
        {
            ...
            titleEl:     'Τεχνικές Μελέτες &amp; Ειδικές Κατασκευές',
            titleEn:     'Technical Studies &amp; Special Bodywork',
            textEl:      'Σχεδιασμός <strong class="kw">από την αρχή</strong>, υπολογισμοί αντοχής και πιστοποίηση <strong class="kw">ειδικών υπερκατασκευών</strong> και <strong class="kw">μετασκευών</strong> — ψυγεία, γερανοί, ανατροπές, κινητά συνεργεία, ειδικά ρυμουλκούμενα. Μελέτες <strong class="kw">τροποποίησης &amp; συμμόρφωσης</strong> για κάθε αλλαγή στο όχημα.',
            textEn:      'Design <strong class="kw">from scratch</strong>, strength calculations and certification of <strong class="kw">special superstructures</strong> and <strong class="kw">conversions</strong> — refrigerated bodies, cranes, tippers, mobile workshops, special trailers. <strong class="kw">Modification &amp; compliance studies</strong> for every change to the vehicle.',
            ...
            items: [
                ...
                },
                {
                    ...
                    titleEn: 'Modification &amp; Compliance Studies',
        ...
        },
        {
            ...
            titleEl:     'Τεχνική Συμβουλευτική &amp; Πιστοποίηση',
            titleEn:     'Technical Consulting &amp; Certification',
            ...
            items: [
                ...
                },
                {
                    ...
                    titleEn: 'Compliance Certificates &amp; Technical Memoranda',
